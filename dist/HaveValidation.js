...
var HaveValidation = function () {
    ...
    _createClass(HaveValidation, [{
        ...
        value: function addError(error) {
            ...
            var sameErrorIndex = this.errors.findIndex(function (e) {
                return e.propName === error.propName && e.errorMsg === error.errorMsg;
            });
            if (!(sameErrorIndex >= 0)) this.errors.push(error);
        }
    }, {
        key: "addErrors",
